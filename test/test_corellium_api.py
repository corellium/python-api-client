...
class TestCorelliumApi(unittest.TestCase):
    ...
    def test_v1_check_subdomain_existence(self):
        """Test case for v1_check_subdomain_existence

        Check the existence of a subdomain  # noqa: E501
        """
        pass
    ...
    def test_v1_get_service_provider_metadata(self):
        """Test case for v1_get_service_provider_metadata

        Get service provider metadata xml from an auth provider  # noqa: E501
        """
        pass
