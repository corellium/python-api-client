...
class InstanceCreateOptions(object):
    ...
    def __init__(self, shared_snapshot=None, shared_snapshot_password=None, name=None, key=None, flavor=None, project=None, os=None, osbuild=None, patches=None, fwpackage=None, orig_fw_package_url=None, encrypt=None, wifi_mac=None, wan_access=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def wan_access(self):
        """Gets the wan_access of this InstanceCreateOptions.  # noqa: E501

        manages internet access  # noqa: E501

        :return: The wan_access of this InstanceCreateOptions.  # noqa: E501
        :rtype: bool
        """
        return self._wan_access

    @wan_access.setter
    def wan_access(self, wan_access):
        """Sets the wan_access of this InstanceCreateOptions.

        manages internet access  # noqa: E501

        :param wan_access: The wan_access of this InstanceCreateOptions.  # noqa: E501
        :type wan_access: bool
        """

        self._wan_access = wan_access
